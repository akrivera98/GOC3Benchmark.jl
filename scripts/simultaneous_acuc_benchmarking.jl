...
function code1(
    ...
    gurobi_MIPGapTol = nothing,
    gurobi_FeasibilityTol = nothing,
    )
    ...
    args = Dict(
        ...
        # ADDED BY ANA for simultaneous_acuc:
        "simultaneous_acuc" => true,
        "include_reserves_in_acuc" => true,
        "relax_thermal_limits" => false,

        # MINLP optimizer arguments
        "minlp_optimizer" => get_optimizer("gurobi"),
        "gurobi_MIPGapTol" => gurobi_MIPGapTol,
        "gurobi_FeasibilityTol" => gurobi_FeasibilityTol,
